...
<div class="container" id="main">
	<div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
		<div class="panel panel-default content-main">
			<form name="question" method="post" action="/api/qna/update?qid=${question.questionId}">
				<div class="form-group">
					<label for="writer">글쓴이</label>
					<input class="form-control" id="writer" name="writer" value="${question.writer}" placeholder="글쓴이" disabled/>
				</div>
				<div class="form-group">
