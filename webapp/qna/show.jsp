				...
				<article class="article">
					...
					<div class="article-util">
						<ul class="article-util-list">
							<li>
								<a class="link-modify-article" href="/qna/update?qid=${question.questionId}">수정</a>
							</li>
							<li>
								<a href="/qna/delete?qid=${question.questionId}">
					...
					<div class="qna-comment-slipp">
						...
						<div class="qna-comment-slipp-articles">
							<c:forEach items="${answers}" var="answer">
								<article class="article" id="article-${answer.answerId}">
									<div class="article-header">
										<div class="article-header-thumb">
										...
										<ul class="article-util-list">
											...
											<li>
												<form class="form-delete" action="/api/qna/deleteAnswer" method="POST">
													...
													<button type="button"
													        onclick="deleteAnswer(this, ${answer.answerId});"
													        class="link-delete-article">삭제
													</button>
												</form>
											</li>
										</ul>
			...
			<ul class="article-util-list">
				...
				<li>
					<form class="form-delete" action="/api/qna/deleteAnswer" method="POST">
						...
						<button type="button" onclick="deleteAnswer(this, {4});" class="link-delete-article">삭제</button>
					</form>
				</li>
			</ul>
		</div>
